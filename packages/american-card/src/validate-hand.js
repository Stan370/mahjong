import { americanMahjongCard2026 } from "./card-2026";
const JOKER_SUIT = "joker";
function getRequiredCount(kind) {
    switch (kind) {
        case "single":
            return 1;
        case "pair":
...
function consumeGroup(counts, jokersLeft, group) {
...
function tryPattern(pattern, hand) {
...
export function validateAmericanMahjongHand(hand) {
