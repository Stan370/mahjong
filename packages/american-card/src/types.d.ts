...
export type TileCode = `bam-${number}` | `crak-${number}` | `dot-${number}` | "wind-east" | "wind-south" | "wind-west" | "wind-north" | "dragon-red" | "dragon-green" | "dragon-white" | `flower-${number}` | `joker-${number}`;
